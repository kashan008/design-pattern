...
public class Player {
    ...
    private static final int TRACK_FIVE_INDEX = 5; // 0-based index for track 5
    ...
    private void damagePlayer() {
        ...
        stopPlayback();
        trackFiveTimer.cancel(); // Cancel the timer as it's no longer needed
    }
    ...
    public void stopPlayback() {
        ...
        setupTrackFiveTimer(); // Re-setup the timer for next use
    }
